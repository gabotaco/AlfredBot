...
module.exports.run = async (bot, args) => {
    return new Promise(async (resolve, reject) => {
        ...
        bot.con.query(`SELECT warnings, discord_id FROM members WHERE ${SearchColumn} = '${args.author_id}'`, function (err, result, fields) { //get the warning number for the member
            if (err) {
                console.log(err)
